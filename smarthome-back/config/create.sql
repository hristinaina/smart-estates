...
INSERT INTO realestate (Id, Type, Address, City, SquareFootage, NumberOfFloors, Picture, State, UserId)
VALUES
    (1, 0, '123 Main St', 'Cityville', 150.5, 2, 'path/to/picture1.jpg', 0, 0),
    (2, 1, '456 Oak Ave', 'Townton', 200.75, 3, 'path/to/picture2.jpg', 1, 1),
    (3, 0, '789 Pine Ln', 'Villageto wn', 30.25, 1, 'path/to/picture3.jpg', 0, 1),
    (4, 1, '101 Elm Blvd', 'Hamlet City', 700.0, 2, 'path/to/picture4.jpg', 2, 2);
